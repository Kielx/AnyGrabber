...
class AnydeskFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.found_file_event.registerCallback(self.generate_and_present_search_results)
        self.finished_searching_event = myEvent()
        self.finished_searching_event.registerCallback(self.finished_searching_callback)
    ...
    def find_files(self, search_path: str, filename: str = "*.trace") -> int:
    ...
    def search_filesystem_callback(self, search_location: str, worker_threads_queue: queue):
        ...
        number_of_found_files = self.find_files("*.trace", search_location)
